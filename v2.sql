...
LOAD DATA LOCAL INFILE '/home/dan/edu/uni/subjects/SQL/mockdata/user.csv' INTO TABLE User fields terminated by ',' enclosed by '' lines terminated by '\n' (UID, UName);

LOAD DATA LOCAL INFILE '/home/dan/edu/uni/subjects/SQL/mockdata/product.csv' INTO TABLE Product fields terminated by ',' enclosed by '' lines terminated by '\n' (PID,Price,PName,Unit) ;
